    ...
    return(
        <div className='lg:w-5/6 h-full'>
            <div className='lg:p-10 p-5 flex flex-col items-center h-full'>
                ...
                <div className='items-center flex flex-wrap bg-gray-100 border border-gray-200 p-5 w-full justify-around rounded-md'>
                ...
                <div className='items-center gap-5 mt-10 flex bg-gray-100 border border-gray-200 p-5 w-full rounded-md'>
                    ...
                    <Link to='/cursos'>
                    <button className='bg-green-500 transition hover:bg-green-600 rounded-md p-1 flex items-center text-white'><HiCurrencyDollar size={60}/></button>
                    </Link>
                </div>
            </div>
        </div>
