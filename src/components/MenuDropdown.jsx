...
export default function MenuDropdown({collapse, visible}) {
  return (
    <div className={`bg-[#F6B112] top-52 left-44 text-center ${visible ? 'lg:block md:block block' : 'hidden'} md:hover:block lg:hover:block fixed ${collapse ? 'lg:top-10' : 'lg:top-40'} md:top-56 rounded-b-lg mt-1 p-4 md:left-48 lg:left-72`}>
        <ul className=''>
            <Link to='passoapasso'>
