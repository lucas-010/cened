...
export default function StudentOption({id ,text, selected, setSelected}) {
  ...
  return (
      <ConditionalLink to='/' condition={id===10}>
			<button onClick={()=>setSelected(id)} className={`${selected ===id ? 'bg-[rgb(150,150,150)]' : ''} font-bold flex gap-5 items-end bg-[rgb(206,222,220)] border-2 border-white  hover:bg-[rgb(150,150,150)] transition-colors p-4 rounded-lg w-full`}>
