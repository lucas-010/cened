...
export default function RegForm3({data, setData}){
    ...
    return(
        <div id='Form3'>
            ...
            <TextField onChange={(e) => setData((data)=>({...data, aluno:{...data.aluno,'condicaoPreso':e.target.value}}))} value={data.aluno.condicaoPreso} select style={{margin:'1%'}} variant="outlined" label='Condição' className='line5' id='condicao'>
