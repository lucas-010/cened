  ...
  return (
    <div className='p-4 mt-2 w-screen'>
			...
			<div className='mt-0 m-auto'>
				...
				<h2 className='mt-10 text-2xl font-bold'>Título</h2>
				<p>Programa de Qualificação Profissional às Pessoas Privadas de Liberdade.</p>

				<h2 className='mt-10 text-2xl font-bold'>Identificação</h2>
				...
				<div className={`text-black text-xl ${currentBox === 2 ? 'block' : 'hidden'}`}>
					<p className='mt-10'>Promover aos internos do sistema penitenciário de regime fechado e semiaberto das penitenciárias masculinas e femininas do país, oportunidades de qualificação profissional inicial e continuada, na forma de cursos de qualificação profissional – EaD, adaptadas às exigências atuais do mercado de trabalho e às necessidades dos estudantes reeducandos, visando à requalificação e à (re)inclusão no mundo do trabalho nas mais diversas áreas em que atuam/atuavam ou venham a atuar, em diferenciados setores produtivos, motivando-os a não reincidir no crime, dando-lhes os subsídios necessários à prática profissional.</p>
				</div>

				<div className={`text-black text-xl ${currentBox === 3 ? 'block' : 'hidden'}`}>
					<ul>
					<li className='mt-10'>✔ Promover a capacitação profissional dos internos do sistema penitenciário, de forma a assegurar o direito do apenado à instrução escolar e formação profissional, em nível de iniciação ou de aperfeiçoamento;</li>

					<li className='mt-10'>✔ Contribuir para a elevação do nível de escolaridade dos reeducandos;</li>

					<li className='mt-10'>✔ Favorecer a aquisição de conhecimentos por meio da leitura;</li>

					<li className='mt-10'>✔ Promover o crescimento pessoal e profissional do reeducando durante o cumprimento da sua pena, visando à recuperação da sua dignidade;</li>

					<li className='mt-10'>✔ Possibilitar a recuperação da autoestima do apenado por meio dos estudos que o qualificarão para o exercício de uma profissão útil à sociedade;</li> 

					<li className='mt-10'>✔ Promover a reinserção do interno ao convívio social;</li>

					<li className='mt-10'>✔ Qualificar os egressos do sistema penitenciário para a (re)inserção no mercado de trabalho, para que não voltem a reincidir no crime;</li>

					<li className="mt-10">✔ Desenvolver e aprimorar as habilidades profissionais dos alunos reclusos;</li>

					<li className="mt-10">✔ Dar condições aos internos para que se tornem aptos a usufruir o direito à remição de pena pelo estudo.</li>

					</ul>
				</div>

				<div className={`text-black text-xl ${currentBox === 4 ? 'block' : 'hidden'}`}>
					<p className='mt-10'>Lei de Diretrizes e Bases da Educação Nacional (LDB) - Lei nº 9.394/1996, em especial, os dispositivos que tratam da Educação Profissional e Tecnológica, que contempla os cursos de qualificação profissional.</p>

					<p className='mt-10'>Lei nº 7.210/84, que institui a Lei de Execução Penal, em especial o artigo 126 que trata da remição da pena pelo estudo, em atividade de ensino fundamental, médio, inclusive profissionalizante, ou superior, ou ainda de requalificação profissional, desenvolvidas de forma presencial ou por metodologia de ensino a distância e devem ser certificadas pelas autoridades educacionais competentes dos cursos frequentados.</p>

					<p className='mt-10'>Decreto nº 7.626/2011, que institui o Plano Estratégico de Educação no âmbito do Sistema Prisional, que contempla, dentre outras, a educação profissional e tecnológica – art. 2º, e que autoriza convênios, acordos de cooperação, ajustes ou instrumentos congêneres, com entidades privadas – art. 10º, com a finalidade de ampliar e qualificar a oferta de educação nos estabelecimentos penais. </p>

					<p className='mt-10'>Resolução/CNJ nº 391/2021, que reconhece o direito à remição de pena por meio de atividades educacionais, dentre outras atividades não-escolares, as de capacitação profissional às pessoas privadas de liberdade, ofertadas pelas instituições de ensino privadas, autorizadas pelo Sistema Penitenciário.</p>
				...
				<h2 className='mt-10 text-2xl font-bold'>Modalidade de ensino e material didático</h2>
				...
				<h2 className='mt-10 text-2xl font-bold'>Carga horária e período de realização</h2>
				...
				<h2 className='mt-10 text-2xl font-bold'>Vagas</h2>
				<p>A oferta dos cursos é ilimitada, porém condicionada às condições do estabelecimento penitenciário.</p>

				<h2 className='mt-10 text-2xl font-bold'>Público-alvo</h2>
				<p>Pessoas privadas de liberdade, do sexo masculino e feminino.</p>

				<h2 className='mt-10 text-2xl font-bold'>Requisitos para o ingresso e formas de acesso</h2>
				...
				<h2 className='mt-10 text-2xl font-bold'>Local de realização</h2>
				...
				<h2 className='mt-10 text-2xl font-bold'>Acompanhamento do curso pelo familiar ou visitante </h2>
				...
				<div className={`text-black text-xl ${currentBox === 6 ? 'block' : 'hidden'}`}>
					<p className='mt-10'>A remição da pena por estudo está prevista no art. 126 da Lei nº 7.210/84 – Lei de Execução Penal. </p>
