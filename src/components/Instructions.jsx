...
export default function Instructions() {
  return (
    <div className='bg-[#EBECF0] border border-black w-11/12 p-4 rounded-xl mt-0 m-auto'>
      <span className='font-semibold text-xl'>Amigo(a) interessado(a),</span>
			...
			<div className=''>
				<Card style={{width: '20em', marginTop: '20px',padding: '10px', backgroundColor: '#E5E7EB', border: '1px black solid',display: 'flex', flexDirection: 'column', justify: 'space-betewenn'}}>
