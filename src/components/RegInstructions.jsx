...
export default function RegInstructions(){
    ...
    return(
        <div className='flex flex-col'>
                <button onClick={() => {visible ? setVisible(false) : setVisible(true)}} className='mt-5 flex flex-col font-bold bg-[#EBECF0] p-2 pl-6 pr-6 rounded-xl max-w-xs border-black border-2 self-center lg:max-w-none lg:text-xl lg:ml-10 lg:self-start lg:w-fit '>
