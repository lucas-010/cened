...
export default function CourseBox({id, image ,title, time, price, addCourseList, removeCourseList, code, coursesSelected}) {
  ...
  return (
    <div className={`flex flex-col lg:w-2/3 w-11/12 mt-10 transition-all bg-gray-300 rounded-xl p-4`}>
        ...
        <div className={`${visibleContent ? 'flex flex-col' : 'hidden'} transition-all justify-between w-full`}>
            ...
            <div className={`${buttonId ===1 ? '' : 'hidden'} mt-5`}>
