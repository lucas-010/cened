...
export default function CourseBox({id, image ,title, time, price}) {
  ...
  return (
    <div className='flex lg:flex-row flex-col mt-2 items-center bg-gray-300 rounded-xl p-4'>
        ...
        <div className='font-bold text-xl'>
            ...
            <div className='flex mt-2 lg:flex-row flex-col'>
                ...
                <button onClick={()=> setSelectBox(!selectBox)} className='flex mt-2 lg:mt-0 lg:flex-row flex-col ml-0 bg-white p-2 rounded-lg lg:ml-5 items-center text-xl font-bold'>Selecione aqui {selectBox ? <GrCheckboxSelected className='ml-2' size={50}/> : <GrCheckbox className='ml-2' size={50}/>}</button>
            </div>
        </div>
    </div>
  )
