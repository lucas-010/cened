...
export default function Intro() {
  ...
  return (
    <div className='mt-20 p-6 md:p-10 lg:mt-36 md:text-2xl' style={{background: 'linear-gradient(0deg, rgba(255,255,255,1) 0%, rgba(240,230,140,1) 100%)'}}>
        ...
        <div className='flex md:mt-10 mt-4 text-xs text-center md:text-xl md:font-bold'>
            ...
            setOpen2(false);setOpen3(false);setOpen1(false);}}><img src={slideImg4} alt='' /><p className='text-white mt-2 hover:bg-green-500 hover:transition-colors text-base rounded-xl pl-2 pr-2 bg-blue-800 w-fit place-self-center'>SAIBA +</p></button>
            </div>
        </div>
