  ...
  return (
    <div className='p-4 flex flex-col items-center'>
			...
			<BoxInfo title={'Realização da prova final'}>
				<p className='text-lg mt-5'>NO DISTRITO FEDERAL
				...
				<p className='text-lg mt-5'>NOS OUTROS ESTADOS
				...
				<p className='text-lg mt-5'>d) Aplicação: serão aplicadas aos Internos, na sua Unidade Prisional, as provas escritas relativas aos cursos concluídos. As provas poderão ser aplicadas pelo Chefe do Núcleo de Ensino ou por quem o Diretor do estabelecimento prisional vier a designar</p>
			...
			<BoxInfo title={'Correção e resultado das provas'}>
				<p className='text-lg mt-5'>A Equipe Pedagógica da Escola CENED fará a correção das provas. O Interno que: </p>
			...
			<BoxInfo title={'Entrega do certificado ao Núcleo de Ensino'}>
				<p className='text-lg mt-5'>NO DISTRITO FEDERAL</p>
				...
				<p className='text-lg mt-5'>NOS OUTROS ESTADOS</p>

				<p className='text-lg mt-5'>A Escola CENED encaminhará, via Correios, os certificados dos Internos aprovados, aos cuidados do Chefe do Núcleo de Ensino, que por sua vez, os repassarão às Assessorias Jurídicas das Unidades Prisionais para as providências quanto à confecção da certidão relativa ao estudo para fins de remição de pena, junto à Execuções Penais ou Criminais.</p>
			</BoxInfo>
			...
			<BoxInfo title={'Da remição de pena'}>
				<p className='text-lg mt-5'>Conforme a Lei de Execução Penal, o aluno/reeducando poderá pleitear o benefício de 1 (um) dia de remição da pena a cada 12 (doze) horas de estudo ou seja, a cada 3 (três) dias de estudo, 1 (um) dia de remição da pena.</p>

				<p className='text-lg mt-5'>Nos termos do artigo 126, parágrafo 2º, da Lei nº 7.210/84 (Lei de Execução Penal), a atividade de estudo desenvolvida a distância ou presencial tem o condão de remir parte do tempo de execução da pena se devidamente certificada pela instituição educacional competente e responsável pelos cursos realizados.</p>

				<p className='text-lg mt-5'>Nos termos da LEP, para calcular os dias a serem remidos em razão do período estudado, desde que não ultrapasse 12 horas a cada três dias ou, em média, 4 horas/dia, será feito da seguinte forma: dividir-se-á a CARGA HORÁRIA TOTAL DO CURSO por 12 horas e encontrar-se-á o TEMPO A SER REMIDO.</p>

				<p className='text-lg mt-5'>A Resolução nº 391/2021, do Conselho Nacional de Justiça, regulamenta o direito à remição de pena por meio de atividades educacionais em unidades de privação de liberdade, que podem ser ofertadas por instituições de ensino públicas ou privadas.</p>
			</BoxInfo>
			...
			<BoxInfo title={'Ação de cooperação educacional entre a Escola CENED e a unidade prisional'}>
				<p className='text-lg mt-5'>Em síntese, a realização dos cursos pelos Internos será executada mediante a ação conjunta entre a Escola CENED e o Núcleo de Ensino do Estabelecimento Prisional, em cumprimento ao exercício do direito do preso à educação, com rotina semanal para:</p>
