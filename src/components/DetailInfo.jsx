  ...
  return (
    <div className='p-4 flex flex-col items-center'>
			...
			<BoxInfo title={'Da remição de pena'}>
				<p className='text-lg mt-5'>Conforme a Lei de Execução Penal, o estudante/reeducando poderá pleitear o benefício de 1 (um) dia de remição da pena a cada 12 (doze) horas <span className='underline'>de estudo</span> ou seja, a cada 3 (três) dias de estudo, 1 (um) dia de remição da pena.</p>
				...
				<p className='text-lg mt-5'>E, ainda, nos termos da LEP, para calcular os dias a serem remidos em razão do período estudado, desde que não ultrapasse 12 horas a cada três dias ou, em média, 4 horas/dia, será feito da seguinte forma: dividir-se-á a CARGA HORÁRIA TOTAL DO CURSO por 12 horas e encontrar-se-á o TEMPO A SER REMIDO.</p>
