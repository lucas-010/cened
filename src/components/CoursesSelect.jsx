...
export default function CoursesSelect({courses, totalPrice, setCoursesSelected}) {
  ...
  return (
    <div className={`${!courses.length > 0 ? 'invisible' : false} bg-[#D1D5DB] lg:fixed lg:right-20 mt-5 lg:mt-0 p-4 rounded-xl md:w-2/3 w-11/12 lg:w-1/4`}>
        ...
        <div className='mt-5 flex flex-col lg:flex-row justify-between'>
          <button onClick={()=> setCoursesSelected([])} className='bg-red-600 text-white text-2xl font-semibold rounded-lg p-2'>Limpar Carrinho</button>
