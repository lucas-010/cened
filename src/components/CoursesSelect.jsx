...
export default function CoursesSelect({courses, totalPrice, setCoursesSelected, setOpenCart, openCart}) {
  return (
    <div className={`${!courses.length && !openCart > 0 ? 'invisible' : false} bg-[#D1D5DB] text-gray-600  lg:fixed lg:right-20 lg:mt-20 md:mt-20 h-fit p-4 rounded-xl md:w-1/2 w-full lg:w-1/4 md`}>
      <CoursesSelectInfo/>
